...
| `aimemo context` | Preview the context block that gets injected |
| `aimemo pin <id>` | Pin an entry so it always appears in context |
| `aimemo unpin <id>` | Remove pin from an entry |
